...
const rankedByQuantity = computed(() => {
  return [...products.products].sort((a, b) => b.quantitySold - a.quantitySold).slice(0, 5)
})
...
<template>
  <div class="border border-gray-200 rounded w-full">
    <div class="flex items-center p-4 border-b border-gray-200 gap-2 justify-between">
      ...
      <SecondaryButton @click="toggleProductRanking">
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-left table-auto border-collapse">
        ...
        <tbody v-if="displayedProductRanking.length" class="text-gray-700 text-sm">
          <tr
        ...
        <tbody v-else>
          <tr>
            <td colspan="4" class="py-12 text-center text-gray-400">
              ...
              <div>No product ranking data available.</div>
            </td>
          </tr>
        </tbody>
      </table>
