          ...
          <div class="flex gap-4 mb-4">
            <div class="w-[35%]">
              <div class="border rounded p-2 h-fit mb-4">
                ...
                >
                  ...
                  <div>
                    Out of a total of
                    <span class="font-bold">{{ product.inventory }}</span> product,
            ...
            <div class="w-[65%] p-3 border border-gray-200 rounded">
              <div class="flex items-center justify-between">
                <p class="font-medium">
                  Price History - {{ formatCurrency(product.latestPrice.price) }}
                </p>
                <SecondaryButton @click="modal.open('update_price', product.latestPrice.price)"
                  >Update Price</SecondaryButton
                >
              </div>
              ...
              <div v-if="activeTab === 'variants'">
                <div class="flex justify-between items-center mb-2">
                  ...
                  <div class="flex gap-2">
                    <SecondaryButton @click="modal.open('new_variant', productId)"
                      >New Variant</SecondaryButton
                    >
                    <PrimaryButton @click="modal.open('edit_variants', productId)"
                      >Update Variants</PrimaryButton
                    >
                  </div>
                </div>
